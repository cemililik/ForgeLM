...
| Change type | Bump |
|---|---|
| Breaking (removed flag, renamed YAML field, changed exit code) | MAJOR |
| New feature (new trainer, new CLI subcommand, new config field) | MINOR |
| Bug fixes, docs, internal refactor | PATCH |
