...
def _vllm_config(
    ...
    comments = "\n".join(f"{k}: {cfg[k] or ''}" for k in comment_keys)
...
def _hf_endpoints_json(
    ...
    spec = {
        ...
        "cloud": {"region": region, "vendor": "aws"},
    ...
    *,
    ...
    try:
        if target == "ollama":
            ...
            content = _hf_endpoints_json(model_path, task, instance_size, instance_type, region, framework)
